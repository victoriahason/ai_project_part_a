...
metadata = {
    ...
    "team_name": f"Canadimericans",

    # Fill in the student IDs and emails of both team members here. There must
    # be exactly two members in the list. 
    "team_members": [
        {
            "name": "Naomi Bahn-Logan",
            "student_id": "1571391",
            "email": "nbahnlogan@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        },
        {
            "name": "Victoria Hason",
            "student_id": "1570520",
            "email": "vhason@student.unimelb.edu.au" # Must be @student.unimelb.edu.au address
        }
    ],
}
